...
#define KBRD_C0_PIN 4
#define KBRD_C1_PIN 5
#define KBRD_C2_PIN 6
#define KBRD_C3_PIN 7
#define KBRD_F0_PIN 0
#define KBRD_F1_PIN 0
#define KBRD_F2_PIN 2
